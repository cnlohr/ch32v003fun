...
$(GENERATED_LD_FILE) :
	$(PREFIX)-gcc -E -P -x c -DCH32V003FUNDIR=$(CH32V003FUN) -DTARGET_MCU=$(TARGET_MCU) -DMCU_PACKAGE=$(MCU_PACKAGE) -DTARGET_MCU_LD=$(TARGET_MCU_LD) $(CH32V003FUN)/ch32v003fun.ld > $(GENERATED_LD_FILE)
